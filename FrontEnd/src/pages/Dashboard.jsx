...
const Dashboard = () => {
  ...
  return (
    <div className='min-h-full max-h-full w-full flex flex-col justify-between  '>

      <div className=' flex m gap-4  flex-wrap  w-full justify-center md:justify-evenly '>
        <div className='h-full w-full sm:h-[250px] sm:w-[250px] md:h-[300px] md:w-[300px] lg:h-[350px] lg:w-[350px] bg-white  rounded-md'  >
